...
function TreasuryStats() {
  const treasuryData = {
    balance: '5.2M ECO',
    monthlyInflow: '+320K ECO',
    monthlyOutflow: '-180K ECO',
    distribution: {
      rewards: 45,
      development: 25,
      community: 20,
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-6">
        <div className="bg-white rounded-xl shadow-sm p-6">
          ...
          <p className="text-2xl font-bold text-gray-900">{treasuryData.balance}</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          ...
          <p className="text-2xl font-bold text-gray-900">{treasuryData.monthlyInflow}</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          ...
          <p className="text-2xl font-bold text-gray-900">{treasuryData.monthlyOutflow}</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        ...
        <div className="space-y-4">
          {Object.entries(treasuryData.distribution).map(([category, percentage]) => (
            <div key={category}>
